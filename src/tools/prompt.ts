...
export function buildToolSystemPrompt(settings: AppSettings): string {
  ...
  return [
    ...
    "- Bei allen Fragen, die ohne externe Prüfung, Berechnung, Dateizugriff oder aktuelle Daten nicht sicher beantwortbar sind, musst du zuerst ein Tool verwenden und darfst erst danach antworten.",
